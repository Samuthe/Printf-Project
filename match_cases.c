...
void (*match_specifier(inventory_t *inv))(inventory_t *)
{
    ...
    static matches_t specifiers_list[] = {
        {'d', p_int}, {'i', p_int}, {'x', p_lowhex}, {'X', p_uphex}, {'o', p_oct}, {'u', p_ulongint}, {'c', p_char}, {'s', p_string}, {'%', p_percent}, {'b', p_binary}, {'p', p_pointer}, {'r', p_rev_string}, {'R', p_rot13}, {'S', p_string_hex}, {'\0', NULL}};
    static matches_t modifiers_long[] = {
        {'d', p_longint}, {'i', p_longint}, {'x', p_longlowhex}, {'X', p_longuphex}, {'o', p_longoct}, {'u', p_ulongint}, {'\0', NULL}};
